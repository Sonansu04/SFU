...
read_vcd -strip_path /SFU_tb/SFU1 ./waveform/relu_fp16.vcd

 

#set_operating_conditions -max slow -max_library slow -min fast -min_library fast
set_power_analysis_options -waveform_interval 0.01 -waveform_format fsdb -waveform_output ./waveform/relu_fp16_syn40_power
...
report_power -hierarchy > ./power/relu/RELU_FP16_h.txt
report_power  	> ./power/relu/RELU_FP16_all.txt
exit
