...
read_vcd -strip_path /SFU_tb/SFU1 ./waveform/log2_fp32.vcd

 

#set_operating_conditions -max slow -max_library slow -min fast -min_library fast
set_power_analysis_options -waveform_interval 0.01 -waveform_format fsdb -waveform_output ./waveform/log2_fp32_syn40_power
...
report_power -hierarchy > ./power/log2/LOG2_FP32_h.txt
report_power  	> ./power/log2/LOG2_FP32_all.txt
exit
